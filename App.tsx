...
import locationTour from './walkthroughs/locations.json';
import dashboardTour from './walkthroughs/dashboard.json';
import characterVaultTour from './walkthroughs/character_vault.json';
...
const App = () => {
  ...
  const getTourData = () => {
    switch (view) {
      case ViewState.LOCATIONS: return locationTour;
      case ViewState.DASHBOARD: return dashboardTour;
      case ViewState.CHARACTERS: return isCharacterModalOpen ? characterModalTour : characterVaultTour;
      default: return null;
    }
  };
